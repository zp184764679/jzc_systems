...
export default function InventoryOut() {
  ...
  const onSubmit = async (e) => {
    ...
    if (!form.bin_code.trim()) { alert('请填写出库仓位'); return }

    setSubmitting(true)
    try {
      await inventoryApi.createOut({
  ...
  return (
    <div style={L.page}>
      <div style={L.header}>
        <h2 style={{ fontSize: 20, fontWeight: 700, margin: 0 }}>出库登记</h2>
